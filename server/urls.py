...
urlpatterns = [
    ...
    path('frontend-api/get-dataset',
         get_default_user_dataset_api, name='get-dataset'),
    path("frontend-api/get-dataset-record/<int:id>",
         get_user_records_api, name="get-record"),
    path("frontend-api/create-dataset",
         create_user_dataset_api, name="create-dataset"),
    path("frontend-api/delete-dataset",
         delete_user_dataset_api, name="delete-dataset"),
    path("frontend-api/update-dataset",
         update_user_dataset_api, name="update-dataset"),
    path("frontend-api/create-record",
         create_user_record_api, name="create-record"),
    path("frontend-api/delete-record",
         delete_user_record_api, name="delete-record"),
    path("frontend-api/update-record",
         update_user_record_api, name="update-record"),
