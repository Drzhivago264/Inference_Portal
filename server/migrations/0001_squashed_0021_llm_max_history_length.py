...
class Migration(migrations.Migration):
    ...
    replaces = [
        ("server", "0001_initial"),
        ("server", "0002_sessiontree"),
        ("server", "0003_memorytree_delete_sessiontree"),
        ("server", "0004_memorytree_p_type"),
        ("server", "0005_memorytree_name"),
        ("server", "0006_memorytree_is_session_start_node_and_more"),
        ("server", "0007_instructiontree"),
        ("server", "0008_rename_default_instructiontree_default_child_and_more"),
        ("server", "0009_instructiontree_parent"),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "availability",
                    models.CharField(default="Not Available", max_length=200),
                ),
                (
                    "hosted_model",
                    models.ForeignKey(
