...
_index28.options.parse.parsers = [(0, _index9.default)({
  allowEmpty: true,
  sourceMap: false
}), (0, _index10.default)({
  allowEmpty: true,
...
_index28.options.resolve.resolvers = [(0, _indexNode.default)(), (0, _index.default)({
  timeout: 5000,
  redirects: 5,
  withCredentials: false
})];
_index28.options.resolve.strategies = [(0, _index2.default)(), (0, _index3.default)(), (0, _index4.default)(), (0, _index5.default)(), (0, _index6.default)()];
_index28.options.dereference.strategies = [(0, _index23.default)(), (0, _index24.default)(), (0, _index25.default)(), (0, _index26.default)(), (0, _index22.default)()];
_index28.options.bundle.strategies = [(0, _index27.default)()];