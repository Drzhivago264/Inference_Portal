...
export declare const StyledAutocompleteOption: import("@mui/styled-engine").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("../styles").Theme> & {
 ...
 */
declare const AutocompleteOption: OverridableComponent<AutocompleteOptionTypeMap<{}, "li">>;
