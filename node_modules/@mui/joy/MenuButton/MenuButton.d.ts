...
export declare const MenuButtonRoot: import("@mui/styled-engine").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("../styles").Theme> & {
 ...
 */
declare const MenuButton: OverridableComponent<MenuButtonTypeMap<{}, "button">>;
