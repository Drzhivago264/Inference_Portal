...
export declare const StyledModalRoot: import("@mui/styled-engine").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("../styles").Theme> & {
    ownerState: ModalOwnerState;
}, React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, {}>;
export declare const StyledModalBackdrop: import("@mui/styled-engine").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("../styles").Theme> & {
    ownerState: ModalOwnerState;
}, React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement>, {}>;
export declare const ModalBackdrop: import("@mui/styled-engine").StyledComponent<Pick<import("@mui/system").MUIStyledCommonProps<import("../styles").Theme> & {
    ownerState: ModalOwnerState;
