...
export declare const StyledAutocompleteListbox: import("@mui/styled-engine").StyledComponent<import("@mui/system").MUIStyledCommonProps<import("../styles").Theme> & {
 ...
 */
declare const AutocompleteListbox: OverridableComponent<AutocompleteListboxTypeMap<{}, "ul">>;
