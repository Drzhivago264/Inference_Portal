...
exports.FinetunedModel = core.serialization.object({
    ...
    settings: core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../../../..")))).finetuning.Settings; })),
    status: core.serialization.lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../../../../..")))).finetuning.Status; })).optional(),
