...
exports.EmbedRequest = core.serialization.object({
    ...
    embeddingTypes: core.serialization.property("embedding_types", core.serialization
        .list(core.serialization.lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("../..")))).EmbedRequestEmbeddingTypesItem; })))
        .optional()),
