...
exports.TogetherAIEmbeddings = void 0;
 ...
 * ```
 */
class TogetherAIEmbeddings extends embeddings_1.Embeddings {
    constructor(fields) {
        super(fields ?? {});
        ...
        const apiKey = fields?.apiKey ?? (0, env_1.getEnvironmentVariable)("TOGETHER_AI_API_KEY");
        if (!apiKey) {
