...
describe("ZepClient", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        client = yield ZepClient.init("z_test-api-key", BASE_URL);
    }));
    describe("getSession", () => {
    ...
    describe("getSessionMessage", () => {
        ...
        it("should throw NotFoundError if the session is not found", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(client.message.getSessionMessage("test-session", "message_uuid")).rejects.toThrow(NotFoundError);
        }));
        ...
        it("should throw APIError when unexpected status code is returned", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect(client.message.getSessionMessage("test-session", "message_uuid")).rejects.toThrow(APIError);
        }));
    });
    ...
    describe("getSessionMessages", () => {
        ...
        it("should retrieve messages for a session", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(messages).toEqual(responseData.messages.map((message) => new Message(message)));
        }));
        it("should throw NotFoundError if the session is not found", () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 404 });
            yield expect(client.message.getSessionMessages("test-session")).rejects.toThrow(NotFoundError);
        }));
        it("should throw APIError when unexpected status code is returned", () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 500 });
            yield expect(client.message.getSessionMessages("test-session")).rejects.toThrow(APIError);
        }));
    });
    ...
    describe("updateSessionMessageMetadata", () => {
        ...
        it("should throw NotFoundError if the session is not found", () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 404 });
            yield expect(client.message.updateSessionMessageMetadata("test-session", "message_uuid", { metadata: { foo: "bar" } })).rejects.toThrow(NotFoundError);
        }));
        it("should throw APIError when unexpected status code is returned", () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 500 });
            yield expect(client.message.updateSessionMessageMetadata("test-session", "message_uuid", { metadata: { foo: "bar" } })).rejects.toThrow(APIError);
        }));
    });
    ...
    it("should throw NotFoundError if the session is not found", () => __awaiter(void 0, void 0, void 0, function* () {
        fetchMock.mockResponseOnce(JSON.stringify({}), { status: 404 });
        yield expect(client.memory.getMemory("test-session")).rejects.toThrow(NotFoundError);
    }));
    ...
    it("should throw APIError when unexpected status code is returned", () => __awaiter(void 0, void 0, void 0, function* () {
        fetchMock.mockResponseOnce(JSON.stringify({}), { status: 500 });
        yield expect(client.memory.getMemory("test-session")).rejects.toThrow(APIError);
    }));
    ...
    describe("addMemory", () => {
        ...
        it("should throw APIError if !200 OK", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 500 });
            yield expect(client.memory.addMemory("test-session", memoryData)).rejects.toThrow(APIError);
        }));
    });
    ...
    describe("deleteMemory", () => {
        ...
        it("should throw NotFoundError if the session is not found", () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 404 });
            yield expect(client.memory.deleteMemory("test-session")).rejects.toThrow(NotFoundError);
        }));
        // Test for throwing APIError when unexpected status code is returned
        it("should throw APIError when unexpected status code is returned", () => __awaiter(void 0, void 0, void 0, function* () {
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 500 });
            yield expect(client.memory.deleteMemory("test-session")).rejects.toThrow(APIError);
        }));
    });
    ...
    describe("searchMemory", () => {
        ...
        it("should throw NotFoundError if the session is not found", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 404 });
            yield expect(client.memory.searchMemory("test-session", searchPayload)).rejects.toThrow(NotFoundError);
        }));
        // Test for throwing APIError when unexpected status code is returned
        it("should throw APIError when unexpected status code is returned", () => __awaiter(void 0, void 0, void 0, function* () {
            const searchPayload = {
            ...
            fetchMock.mockResponseOnce(JSON.stringify({}), { status: 500 });
            yield expect(client.memory.searchMemory("test-session", searchPayload)).rejects.toThrow(APIError);
        })); // end it
    }); // end describe
