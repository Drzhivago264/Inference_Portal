...
class DocumentManager {
     ...
     */
    addCollection({ name, description, metadata, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/collections/${name}`), {
                method: "POST",
    ...
    getCollection(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/collections/${name}`), {
    ...
    updateCollection({ name, description, metadata, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/collections/${collection.name}`), {
                method: "PATCH",
                headers: Object.assign(Object.assign({}, this.client.headers), { "Content-Type": "application/json" }),
                body: JSON.stringify(collection.toDict()),
            }));
    ...
    deleteCollection(collectionName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/collections/${collectionName}`), {
                method: "DELETE",
                headers: this.client.headers,
            }));
        });
