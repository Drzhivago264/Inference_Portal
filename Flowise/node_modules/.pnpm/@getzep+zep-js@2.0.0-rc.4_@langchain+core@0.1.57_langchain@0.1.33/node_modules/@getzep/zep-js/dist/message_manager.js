...
class MessageManager {
    ...
    getSessionMessages(sessionId, limit, cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return responseData.messages.map((message) => new message_models_1.Message(message));
        });
    }
    getSessionMessage(sessionId, messageId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/sessions/${sessionId}/messages/${messageId}`), {
                headers: this.client.headers,
            }), `No session found for session ${sessionId}, or message ${messageId}`);
            const responseData = yield response.json();
            return new message_models_1.Message(responseData);
        });
    }
