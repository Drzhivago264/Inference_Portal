...
describe("CollectionManager", () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        client = yield zep_client_1.default.init("z_test-api-key", API_URL);
    ...
    describe("addCollection", () => {
        it("calls the correct endpoint with the correct method and headers", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            fetchMock.mockResponseOnce(JSON.stringify(mockCollection));
            yield manager.addCollection({ name: "test" });
            expect(fetchMock.mock.calls[1][0]).toEqual(`${BASE_URL}/collections/test`);
