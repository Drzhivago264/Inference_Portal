...
class UserManager {
    ...
    add(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/users`), {
                method: "POST",
    ...
    get(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/users/${userId}`), {
    ...
    update(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/users/${user.user_id}`), {
                method: "PATCH",
                headers: Object.assign(Object.assign({}, this.client.headers), { "Content-Type": "application/json" }),
    ...
    list(limit, cursor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, utils_1.handleRequest)(fetch(`${this.client.getFullUrl("/users")}?${params.toString()}`, {
                headers: this.client.headers,
            }));
    ...
    getSessions(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (0, utils_1.handleRequest)(fetch(this.client.getFullUrl(`/users/${userId}/sessions`), {
                headers: this.client.headers,
