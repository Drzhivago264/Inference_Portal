...
class MemoryManager {
    ...
    synthesizeQuestion(sessionId, lastN = 3) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield (0, utils_1.handleRequest)(fetch(`${this.client.getFullUrl(`/sessions/${sessionId}/synthesize_question`)}?lastNMessages=${lastN}`, {
                headers: this.client.headers,
            }), `No session found for session ${sessionId}`);
            const responseData = (yield response.json());
            ...
            if (data.messages) {
                return new memory_models_1.Memory({
                    messages: data.messages.map((message) => {
                        return new message_models_1.Message(message);
                    }),
