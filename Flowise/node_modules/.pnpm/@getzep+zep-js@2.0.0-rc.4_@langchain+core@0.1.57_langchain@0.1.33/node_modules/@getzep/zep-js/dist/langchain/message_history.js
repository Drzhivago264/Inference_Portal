...
class ZepChatMessageHistory extends chat_history_1.BaseChatMessageHistory {
            ...
            if (memory.messages) {
                messages.push(...memory.messages.map((msg) => {
                    ...
                    if (msg.role_type === "assistant") {
                        return new messages_1.AIMessage(msg.content, metadata);
                    }
                    return new messages_1.HumanMessage(msg.content, metadata);
                }));
            }
            return messages;
        });
    ...
    addMessage(message, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const zepMessage = new message_models_1.Message({
                content: message.content,
                role: (_a = message.name) !== null && _a !== void 0 ? _a : message._getType(),
                role_type: (0, message_models_1.getZepMessageRoleType)(message._getType()),
                metadata,
            });
            const zepMemory = new memory_models_1.Memory({ messages: [zepMessage] });
