...
exports.MemorySearchResult = exports.MemorySearchPayload = exports.Memory = exports.Summary = exports.Session = void 0;
...
class Memory {
     ...
     */
    constructor(data = {}) {
        this.messages = (data.messages || []).map((messageData) => new message_models_1.Message(messageData));
        this.metadata = data.metadata || {};
...
class MemorySearchResult {
     ...
     */
    constructor(data = {}) {
        this.message = data.message ? new message_models_1.Message(data.message) : undefined;
        this.summary = data.summary ? new Summary(data.summary) : undefined;
        this.metadata = data.metadata || {};
