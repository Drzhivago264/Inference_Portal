...
import { Memory, MemorySearchResult, Session, } from "./memory_models";
...
export default class MemoryManager {
    ...
    synthesizeQuestion(sessionId, lastN = 3) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!sessionId || !sessionId.trim()) {
                throw new Error("sessionId must be provided");
            }
            const response = yield handleRequest(fetch(`${this.client.getFullUrl(`/sessions/${sessionId}/synthesize_question`)}?lastNMessages=${lastN}`, {
                headers: this.client.headers,
            }), `No session found for session ${sessionId}`);
            const responseData = (yield response.json());
     ...
     */
    getMemory(sessionID, type, lastn) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    classifySession(sessionId, name, classes, lastN, persist = true, instruction = undefined) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!sessionId || sessionId.trim() === "") {
                throw new Error("sessionId must be provided");
            }
