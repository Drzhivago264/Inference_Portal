import { ClassifySessionResponse, Memory, MemorySearchPayload, MemorySearchResult, Session } from "./memory_models";
...
export default class MemoryManager {
    ...
    synthesizeQuestion(sessionId: string, lastN?: number): Promise<string>;
    /**
     * Adds a session.
     *
     ...
     */
    getMemory(sessionID: string, type?: MemoryType, lastn?: number): Promise<Memory | null>;
    /**
     ...
     */
    classifySession(sessionId: string, name: string, classes: string[], lastN?: number, persist?: boolean, instruction?: string | undefined): Promise<ClassifySessionResponse>;
}
