...
export declare class QdrantClient {
     ...
     */
    scroll(collection_name: string, { shard_key, filter, consistency, limit, offset, with_payload, with_vector, order_by, }?: SchemaFor<'ScrollRequest'> & {
        consistency?: SchemaFor<'ReadConsistency'>;
    }): Promise<{
        points: {
            id: string | number;
     ...
     */
    recoverSnapshot(collection_name: string, { location, priority, checksum }: SchemaFor<'SnapshotRecover'>): Promise<boolean>;
    /**
