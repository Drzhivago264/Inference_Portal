import { ICustomElement, PropsDefinition } from "./utils";
export declare function getCurrentElement(): HTMLElement & ICustomElement;
export declare function noShadowDOM(): void;
export declare function createElementType<T>(BaseElement: typeof HTMLElement, propDefinition: PropsDefinition<T>): {
    new (): {
        [prop: string]: any;
