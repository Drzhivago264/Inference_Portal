...
export interface IDataClient {
    ...
    setBatch(cacheName: string, items: Record<string, string | Uint8Array> | Map<string | Uint8Array, string | Uint8Array>, ttl?: number): Promise<SetBatch.Response>;
    ...
    sortedSetRemoveElements(cacheName: string, sortedSetName: string, values: string[] | Uint8Array[]): Promise<CacheSortedSetRemoveElement.Response>;
