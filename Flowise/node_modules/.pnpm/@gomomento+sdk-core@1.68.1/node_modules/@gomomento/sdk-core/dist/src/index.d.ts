...
export { VectorFilterExpression, VectorFilterExpressions, } from './messages/vector-index-filters';
...
export { IVectorIndexClient, SearchOptions, ALL_VECTOR_METADATA, VECTOR_DEFAULT_TOPK, } from './clients/IVectorIndexClient';
