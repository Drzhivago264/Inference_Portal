...
async function fetcherImpl(args) {
  ...
  const url = Object.keys(args.queryParameters ?? {}).length > 0 ? `${args.url}?${qs.stringify(args.queryParameters, { arrayFormat: "repeat" })}` : args.url;
  let body = void 0;
  ...
  const fetchFn = typeof fetch == "function" ? fetch : __require("node-fetch");
...
var DataSinkUpdateComponentOne = schemas_exports.undiscriminatedUnion([
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ChromaVectorStore),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).PineconeVectorStore),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).PgVectorStore),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).QdrantVectorStore),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).WeaviateVectorStore)
]);
...
var DataSinkUpdateComponent = schemas_exports.undiscriminatedUnion([
  ...
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSinkUpdateComponentOne)
]);
...
var DataSinkUpdate = schemas_exports.object({
  ...
  sinkType: schemas_exports.property(
    "sink_type",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ConfigurableDataSinkNames)
  ),
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSinkUpdateComponent).optional()
});
...
var DataSourceUpdateComponentOne = schemas_exports.undiscriminatedUnion([
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DiscordReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).NotionPageReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).SlackReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).SimpleWebPageReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).TrafilaturaWebReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).BeautifulSoupWebReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).RssReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).YoutubeTranscriptReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).GoogleDocsReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).GoogleSheetsReader),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ReaderConfig),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DocumentGroup),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).TextNode),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).Document)
]);
...
var DataSourceUpdateComponent = schemas_exports.undiscriminatedUnion([
  schemas_exports.record(schemas_exports.string(), schemas_exports.unknown()),
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSourceUpdateComponentOne),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ExternallyStoredComponent)
]);

// src/serialization/resources/dataSource/client/upsertDataSourceFromFiles.ts
var upsertDataSourceFromFiles_exports = {};
__export(upsertDataSourceFromFiles_exports, {
  Response: () => Response
});
var Response = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSource));

// src/serialization/resources/dataSource/client/getDataSourceFiles.ts
var getDataSourceFiles_exports = {};
__export(getDataSourceFiles_exports, {
  Response: () => Response2
});
var Response2 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).LoadedFile));

// src/serialization/resources/dataSource/client/getDataSourceExecutions.ts
var getDataSourceExecutions_exports = {};
__export(getDataSourceExecutions_exports, {
  Response: () => Response3
});
var Response3 = schemas_exports.list(
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSourceLoadJobRecord)
);
...
var DataSourceUpdate = schemas_exports.object({
  ...
  sourceType: schemas_exports.property(
    "source_type",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ConfigurableDataSourceNames)
  ),
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSourceUpdateComponent).optional()
});
...
var getKeys_exports = {};
__export(getKeys_exports, {
  Response: () => Response5
});
var Response5 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ApiKey));
...
__export(listProjects_exports, {
  Response: () => Response6
});
var Response6 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).Project));

// src/serialization/resources/project/client/getDatasetsForProject.ts
var getDatasetsForProject_exports = {};
__export(getDatasetsForProject_exports, {
  Response: () => Response7
});
var Response7 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalDataset));
...
__export(searchPipelines_exports, {
  Response: () => Response8
});
var Response8 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).Pipeline));

// src/serialization/resources/pipeline/client/getLoadedFilesForPipeline.ts
var getLoadedFilesForPipeline_exports = {};
__export(getLoadedFilesForPipeline_exports, {
  Response: () => Response9
});
var Response9 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).LoadedFile));

// src/serialization/resources/pipeline/client/getAllPlaygroundJobs.ts
var getAllPlaygroundJobs_exports = {};
__export(getAllPlaygroundJobs_exports, {
  Response: () => Response10
});
var Response10 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).PlaygroundJobRecord));

// src/serialization/resources/pipeline/client/getPlaygroundJobResult.ts
var getPlaygroundJobResult_exports = {};
__export(getPlaygroundJobResult_exports, {
  Response: () => Response11
});
var Response11 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).PlatformTextNode));

// src/serialization/resources/pipeline/client/getEvalDatasetExecutions.ts
var getEvalDatasetExecutions_exports = {};
__export(getEvalDatasetExecutions_exports, {
  Response: () => Response12
});
var Response12 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalDatasetJobRecord));

// src/serialization/resources/pipeline/client/getEvalDatasetExecutionResult.ts
var getEvalDatasetExecutionResult_exports = {};
__export(getEvalDatasetExecutionResult_exports, {
  Response: () => Response13
});
var Response13 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalQuestionResult));

// src/serialization/resources/pipeline/client/runManagedRawFilesIngestion.ts
var runManagedRawFilesIngestion_exports = {};
__export(runManagedRawFilesIngestion_exports, {
  Response: () => Response14
});
var Response14 = schemas_exports.list(
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSourceManagedIngestionJobRecord)
);
...
__export(getManagedDataSourceIngestionExecutions_exports, {
  Response: () => Response15
});
...
__export(getManagedPipelineIngestionExecutions_exports, {
  Response: () => Response16
});
var Response16 = schemas_exports.list(
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).PipelineManagedIngestionJobRecord)
);
...
var PipelineUpdate = schemas_exports.object({
  configuredTransformations: schemas_exports.property(
    ...
    schemas_exports.list(
      schemas_exports.lazyObject(
        async () => (await import("./serialization-LMUCV53J.js")).ConfiguredTransformationItem
      )
    ).optional()
  ),
  ...
  dataSources: schemas_exports.property(
    "data_sources",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSourceCreate)).optional()
  ),
  ...
  dataSinks: schemas_exports.property(
    "data_sinks",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSinkCreate)).optional()
  ),
  presetRetrievalParameters: schemas_exports.property(
    "preset_retrieval_parameters",
    schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).PresetRetrievalParams).optional()
  ),
  evalParameters: schemas_exports.property(
    "eval_parameters",
    schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalExecutionParams).optional()
  ),
  name: schemas_exports.string().optional(),
...
var EvalExecutionCreate = schemas_exports.object({
  ...
  params: schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalExecutionParamsOverride).optional()
});
...
__export(getQuestions_exports, {
  Response: () => Response17
});
var Response17 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalQuestion));
...
var Request = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalQuestionCreate));
var Response18 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalQuestion));

// src/serialization/resources/eval/client/getSupportedModels.ts
var getSupportedModels_exports = {};
__export(getSupportedModels_exports, {
  Response: () => Response19
});
var Response19 = schemas_exports.list(
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).SupportedEvalLlmModel)
);
...
__export(getAllTransformationDefinitions_exports, {
  Response: () => Response20
});
var Response20 = schemas_exports.list(
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ConfigurableTransformationDefinition)
);
...
__export(getAllDataSourceDefinitions_exports, {
  Response: () => Response21
});
var Response21 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSourceDefinition));

// src/serialization/resources/componentDefinition/client/getAllDataSinkDefinitions.ts
var getAllDataSinkDefinitions_exports = {};
__export(getAllDataSinkDefinitions_exports, {
  Response: () => Response22
});
var Response22 = schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSinkDefinition));
...
var ConfigurableTransformationDefinition = schemas_exports.object({
  ...
  configurableTransformationType: schemas_exports.property(
    ...
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ConfigurableTransformationNames)
  ),
  transformationCategory: schemas_exports.property(
    "transformation_category",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).TransformationCategoryNames)
  )
});
...
var ConfiguredTransformationItemComponentOne = schemas_exports.undiscriminatedUnion([
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).CodeSplitter),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).SentenceSplitter),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).TokenTextSplitter),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).HtmlNodeParser),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).MarkdownNodeParser),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).JsonNodeParser),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).SimpleFileNodeParser),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).OpenAiEmbedding),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).AzureOpenAiEmbedding)
]);
...
var ConfiguredTransformationItemComponent = schemas_exports.undiscriminatedUnion([
  schemas_exports.record(schemas_exports.string(), schemas_exports.unknown()),
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ConfiguredTransformationItemComponentOne)
]);
...
var ConfiguredTransformationItem = schemas_exports.object({
  ...
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ConfiguredTransformationItemComponent)
});
...
var DataSinkComponent = schemas_exports.undiscriminatedUnion([
  schemas_exports.record(schemas_exports.string(), schemas_exports.unknown()),
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSinkComponentOne)
]);
...
var DataSink = schemas_exports.object({
  ...
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSinkComponent)
});
...
var DataSinkCreateComponent = schemas_exports.undiscriminatedUnion([
  schemas_exports.record(schemas_exports.string(), schemas_exports.unknown()),
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSinkCreateComponentOne)
]);
...
var DataSinkCreate = schemas_exports.object({
  ...
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSinkCreateComponent)
});
...
var DataSourceComponent = schemas_exports.undiscriminatedUnion([
  schemas_exports.record(schemas_exports.string(), schemas_exports.unknown()),
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSourceComponentOne),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ExternallyStoredComponent)
]);
...
var DataSource = schemas_exports.object({
  ...
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSourceComponent)
});
...
var DataSourceCreateComponent = schemas_exports.undiscriminatedUnion([
  schemas_exports.record(schemas_exports.string(), schemas_exports.unknown()),
  schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSourceCreateComponentOne),
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ExternallyStoredComponent)
]);
...
var DataSourceCreate = schemas_exports.object({
  ...
  component: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DataSourceCreateComponent)
});
...
var DataSourceLoadJobRecord = schemas_exports.object({
  ...
  jobName: schemas_exports.property(
    "job_name",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).JobNames).optional()
  ),
  status: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).StatusEnum),
...
var DataSourceManagedIngestionJobRecord = schemas_exports.object({
  ...
  jobName: schemas_exports.property(
    "job_name",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).JobNames)
  ),
  status: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).StatusEnum),
  startedAt: schemas_exports.property("started_at", schemas_exports.date().optional()),
  endedAt: schemas_exports.property("ended_at", schemas_exports.date().optional()),
...
var DocumentRelationshipsValue = schemas_exports.undiscriminatedUnion([
  schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).RelatedNodeInfo),
  schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).RelatedNodeInfo))
]);
...
var Document = schemas_exports.object({
  ...
  relationships: schemas_exports.record(
    ...
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).DocumentRelationshipsValue)
  ).optional(),
...
var DocumentGroup = schemas_exports.object({
  ...
  documents: schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).Document)),
  className: schemas_exports.property("class_name", schemas_exports.string().optional())
});
...
var EvalDatasetJobRecord = schemas_exports.object({
  ...
  evalExecutionParams: schemas_exports.property(
    ...
    schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalExecutionParams)
  )
});
...
var EvalExecutionParams = schemas_exports.object({
  llmModel: schemas_exports.property(
    "llm_model",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).SupportedEvalLlmModelNames).optional()
  ),
...
var EvalQuestionResult = schemas_exports.object({
  ...
  sourceNodes: schemas_exports.property(
    "source_nodes",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).TextNode))
  ),
  ...
  evalMetrics: schemas_exports.property(
    ...
    schemas_exports.record(
      schemas_exports.string(),
      schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).MetricResult)
    )
  ),
...
var HttpValidationError = schemas_exports.object({
  detail: schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ValidationError)).optional()
});
...
var LoadedFilePayload = schemas_exports.object({
  ...
  documents: schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).Document)).optional(),
  className: schemas_exports.property("class_name", schemas_exports.string().optional())
});
...
var Pipeline = schemas_exports.object({
  configuredTransformations: schemas_exports.property(
    "configured_transformations",
    schemas_exports.list(
      schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ConfiguredTransformationItem)
    )
  ),
  id: schemas_exports.string(),
  createdAt: schemas_exports.property("created_at", schemas_exports.date().optional()),
  ...
  pipelineType: schemas_exports.property(
    "pipeline_type",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).PipelineType).optional()
  ),
  managedPipelineId: schemas_exports.property("managed_pipeline_id", schemas_exports.string().optional()),
  presetRetrievalParameters: schemas_exports.property(
    "preset_retrieval_parameters",
  ...
  managedIngestionStatus: schemas_exports.property(
    ...
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ManagedIngestionStatus).optional()
  ),
  dataSources: schemas_exports.property(
    "data_sources",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSource))
  ),
  dataSinks: schemas_exports.property(
    "data_sinks",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).DataSink))
  )
});
...
var PipelineCreate = schemas_exports.object({
  configuredTransformations: schemas_exports.property(
    "configured_transformations",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).ConfiguredTransformationItem)).optional()
  ),
  dataSourceIds: schemas_exports.property(
    "data_source_ids",
    schemas_exports.list(schemas_exports.string()).optional()
...
var PlatformTextNode = schemas_exports.object({
  ...
  relationships: schemas_exports.record(
    schemas_exports.string(),
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).PlatformTextNodeRelationshipsValue)
  ).optional(),
  text: schemas_exports.string().optional(),
  startCharIdx: schemas_exports.property("start_char_idx", schemas_exports.number().optional()),
  endCharIdx: schemas_exports.property("end_char_idx", schemas_exports.number().optional()),
...
var Project = schemas_exports.object({
  ...
  createdAt: schemas_exports.property("created_at", schemas_exports.date().optional()),
  updatedAt: schemas_exports.property("updated_at", schemas_exports.date().optional()),
  pipelines: schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).Pipeline)),
...
var ReaderConfig = schemas_exports.object({
  reader: schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).BasePydanticReader),
...
var RelatedNodeInfo = schemas_exports.object({
  ...
  nodeType: schemas_exports.property(
    "node_type",
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ObjectType).optional()
  ),
...
var RetrieveResults = schemas_exports.object({
  ...
  retrievalNodes: schemas_exports.property(
    "retrieval_nodes",
    schemas_exports.list(schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).TextNodeWithScore))
  ),
...
var SupportedEvalLlmModel = schemas_exports.object({
  name: schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).SupportedEvalLlmModelNames),
  details: schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).EvalLlmModelData)
});
...
var TextNode = schemas_exports.object({
  ...
  relationships: schemas_exports.record(
    schemas_exports.string(),
    schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).TextNodeRelationshipsValue)
  ).optional(),
  text: schemas_exports.string().optional(),
  startCharIdx: schemas_exports.property("start_char_idx", schemas_exports.number().optional()),
  endCharIdx: schemas_exports.property("end_char_idx", schemas_exports.number().optional()),
...
var TextNodeWithScore = schemas_exports.object({
  node: schemas_exports.lazyObject(async () => (await import("./serialization-LMUCV53J.js")).TextNode),
  score: schemas_exports.number().optional(),
  className: schemas_exports.property("class_name", schemas_exports.string().optional())
});
...
var ValidationError = schemas_exports.object({
  loc: schemas_exports.list(schemas_exports.lazy(async () => (await import("./serialization-LMUCV53J.js")).ValidationErrorLocItem)),
...
export {
  ...
  DataSourceUpdate,
  dataSource_exports,
  health_exports2 as health_exports,
  ApiKeyCreate,
  ApiKeyUpdate,
  apiKey_exports,
  ProjectUpdate,
  ...
  PipelineUpdate,
  EvalExecutionCreate,
  BodyRunManagedRawFilesIngestionApiPipelinePipelineIdManagedIngestRawFilesPut,
  RetrievalParams,
  pipeline_exports,
  EvalDatasetUpdate,
  eval_exports,
  componentDefinition_exports,
  ApiKey,
...
//# sourceMappingURL=chunk-GJ4BQPLT.js.map