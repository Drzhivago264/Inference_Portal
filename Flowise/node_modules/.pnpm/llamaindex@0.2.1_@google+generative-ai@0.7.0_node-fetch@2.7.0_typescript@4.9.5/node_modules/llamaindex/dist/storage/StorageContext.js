...
export async function storageContextFromDefaults({ docStore, indexStore, vectorStore, imageVectorStore, storeImages, persistDir, fs }) {
    if (!persistDir) {
        ...
        imageVectorStore = storeImages ? await SimpleVectorStore.fromPersistDir(path.join(persistDir, DEFAULT_IMAGE_VECTOR_NAMESPACE), fs) : imageVectorStore;
    }
    return {
        docStore,
        indexStore,
