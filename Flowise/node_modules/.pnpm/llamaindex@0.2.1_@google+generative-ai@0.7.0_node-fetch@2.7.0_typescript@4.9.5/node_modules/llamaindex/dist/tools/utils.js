 ...
 * @returns: tool output
 */ export async function callToolWithErrorHandling(tool, inputDict, errorMessage = null, raiseError = false) {
    try {
        ...
        return new ToolOutput(errorMessage, tool.metadata.name, {
            kwargs: inputDict
        }, e);
    }
}
