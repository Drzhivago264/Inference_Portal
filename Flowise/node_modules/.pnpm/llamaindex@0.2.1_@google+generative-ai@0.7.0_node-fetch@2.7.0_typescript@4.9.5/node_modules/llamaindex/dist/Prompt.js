...
export const anthropicSummaryPrompt = ({ context = "" })=>{
...
*/ export const defaultRefinePrompt = ({ query = "", existingAnswer = "", context = "" })=>{
...
*/ export function buildToolsText(tools) {
...
// <Standalone question>
// """
export const defaultCondenseQuestionPrompt = ({ chatHistory = "", question = "" })=>{
...
export function messagesToHistoryStr(messages) {
...
export const defaultKeywordExtractPrompt = ({ context = "", maxKeywords = 10 })=>{
    return `
...
export const defaultQueryKeywordExtractPrompt = ({ question = "", maxKeywords = 10 })=>{
    return `(
