...
export declare enum ChatResponseMode {
    WAIT = "wait",
    STREAM = "stream"
}
export declare class AgentChatResponse {
    response: string;
    sources: ToolOutput[];
    sourceNodes?: BaseNode[];
    constructor(response: string, sources?: ToolOutput[], sourceNodes?: BaseNode[]);
    protected _getFormattedSources(): void;
    toString(): string;
}
export declare class StreamingAgentChatResponse {
    response: AsyncIterable<Response>;
    sources: ToolOutput[];
    sourceNodes?: BaseNode[];
    constructor(response: AsyncIterable<Response>, sources?: ToolOutput[], sourceNodes?: BaseNode[]);
}
