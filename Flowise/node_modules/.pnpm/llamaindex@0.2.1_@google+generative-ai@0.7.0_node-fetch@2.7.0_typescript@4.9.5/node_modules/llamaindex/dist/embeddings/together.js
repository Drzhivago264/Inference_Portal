...
export class TogetherEmbedding extends OpenAIEmbedding {
    constructor(init){
        const { apiKey = getEnv("TOGETHER_API_KEY"), additionalSessionOptions = {}, model = "togethercomputer/m2-bert-80M-32k-retrieval", ...rest } = init ?? {};
        if (!apiKey) {
        ...
        additionalSessionOptions.baseURL = additionalSessionOptions.baseURL ?? "https://api.together.xyz/v1";
        super({
            apiKey,
