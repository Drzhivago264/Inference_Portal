...
_export(exports, {
    ...
    SimpleChatHistory: function() {
        return SimpleChatHistory;
    },
    SummaryChatHistory: function() {
        return SummaryChatHistory;
    },
    getHistory: function() {
        return getHistory;
    }
...
class SimpleChatHistory extends ChatHistory {
    ...
    async requestMessages(transientMessages) {
        return [
            ...transientMessages ?? [],
            ...this.messages
        ];
...
class SummaryChatHistory extends ChatHistory {
    ...
    constructor(init){
        ...
        this.messages = init?.messages ?? [];
        this.messagesBefore = this.messages.length;
        this.summaryPrompt = init?.summaryPrompt ?? _Prompt.defaultSummaryPrompt;
            ...
            promptMessages = [
                {
                    content: this.summaryPrompt({
                        context: (0, _Prompt.messagesToHistoryStr)(messagesToSummarize)
                    }),
                    role: "user"
                }
            ];
