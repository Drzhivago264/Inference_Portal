...
async function combineResponses(summarizer, responses, queryBundle, verbose = false) {
    ...
    return new _Response.Response(summary, sourceNodes);
}
class RouterQueryEngine extends _index.PromptMixin {
    ...
    constructor(init){
        super();
        this.serviceContext = init.serviceContext || (0, _ServiceContext.serviceContextFromDefaults)({});
        this.selector = init.selector;
        this.queryEngines = init.queryEngineTools.map((tool)=>tool.queryEngine);
        this.metadatas = init.queryEngineTools.map((tool)=>({
                description: tool.description
            }));
        this.summarizer = init.summarizer || new _index2.TreeSummarize(this.serviceContext);
