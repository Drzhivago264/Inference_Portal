...
_export(exports, {
    ...
    MetadataMode: function() {
        return MetadataMode;
    },
    NodeRelationship: function() {
    ...
    splitNodesByType: function() {
        return splitNodesByType;
    }
});
...
class BaseNode {
   ...
   */ toMutableJSON() {
        return _lodash.default.cloneDeep(this.toJSON());
    }
}
class TextNode extends BaseNode {
   ...
   * @returns
   */ generateHash() {
        const hashFunction = (0, _env.createSHA256)();
...
class ImageNode extends TextNode {
    ...
    getUrl() {
        ...
        const absPath = _env.path.resolve(this.id_);
