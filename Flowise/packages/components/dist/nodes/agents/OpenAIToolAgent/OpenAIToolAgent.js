...
const prepareAgent = (nodeData, flowObj) => {
    ...
    const modelWithTools = model.bind({ tools: tools.map(function_calling_1.convertToOpenAITool) });
...
//# sourceMappingURL=OpenAIToolAgent.js.map