...
class MySQLRecordManager {
    constructor(namespace, config) {
        ...
        this.datasource = new typeorm_1.DataSource(mysqlOptions);
    }
    async createSchema() {
        try {
...
\`namespace\`));`);
            ...
            for (const column of columns) {
                ...
                const Check = await this.queryRunner.manager.query(`SELECT COUNT(1) IndexIsThere FROM INFORMATION_SCHEMA.STATISTICS 
