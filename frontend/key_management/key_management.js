import {
	KeyCheckDisplay,
	XMRWConfirmationDisplay,
	XMRWalletDisplay,
} from "../component/custom_ui_component/KeyDisplay.js";
					...
					<StyledPaper variant='outlined'>
						<ThemeProvider theme={fontsizetheme}>
							<Typography variant='h4'>
								<Box sx={{ mb: 2, fontWeight: "bold" }}>
									{" "}
									{t(
										"key_management.Get_started_with_Professor_Parakeet"
									)}
								</Box>
							</Typography>
						</ThemeProvider>
						<Typography variant='h5'>
							<Box sx={{ lineHeight: 2, fontWeight: "700" }}>
								{" "}
								{t("key_management.1_Create_a_Key")}{" "}
							</Box>
						</Typography>
						<Typography variant='body1'>
							{t(
								"key_management.Start_by_generating_a_random_key_by_giving_it_a_name"
							)}
						</Typography>
						<Box
							my={4}
						...
						{serverkeycreatedata && (
							<KeyCreateExport
								...
								integrated_wallet={
									serverkeycreatedata.integrated_wallet
								}
								t={t}
						...
						{serverkeycreateerror && (
							<SuccessErrorAlert
								detail={
									serverkeycreateerror.response.data.detail
								}
								type='error'
							/>
						)}
							...
							<form autoComplete='off'>
								...
								<Accordion
									...
									<AccordionSummary
										...
										<Typography variant='h6'>
											{t(
												"key_management.21_Check_credit_balance"
											)}
										</Typography>
									</AccordionSummary>
									<AccordionDetails>
										...
										{keycheckdata && (
											<KeyCheckDisplay
												...
												monero_balance={
													keycheckdata.monero_balance
												}
												fiat_balance={
													keycheckdata.fiat_balance
												}
											/>
										)}
										{keycheckerror && (
								...
								<Accordion
									...
									<AccordionSummary
										...
										<Typography variant='h6'>
											{t(
												"key_management.22_Pay_by_Stripe"
											)}
										</Typography>
									</AccordionSummary>
									<AccordionDetails>
								...
								<Accordion
									...
									onChange={handleAccordionExpand("panel3")}>
									<AccordionSummary
										expandIcon={<ExpandMoreIcon />}
										...
										<Typography variant='h6'>
											{t(
												"key_management.23_Retrieve_XMR_wallet"
											)}
										</Typography>
									</AccordionSummary>
									<AccordionDetails>
										...
										{xmrretrievedata && (
											<XMRWalletDisplay
												...
												key_name={
													xmrretrievedata.key_name
												}
												payment_id={
													xmrretrievedata.payment_id
												}
												integrated_wallet={
													xmrretrievedata.integrated_wallet
												}
											/>
										)}
										{xmrretrieveerror && (
								...
								<Accordion
									...
									onChange={handleAccordionExpand("panel4")}>
									<AccordionSummary
										expandIcon={<ExpandMoreIcon />}
										...
										<Typography variant='h6'>
											{t(
												"key_management.24_Confirm_XMR_Payment"
											)}
										</Typography>
									</AccordionSummary>
									<AccordionDetails>
										...
										{xmrconfirmdata && (
											<XMRWConfirmationDisplay
												t={t}
												detail={xmrconfirmdata.detail}
											/>
										)}
										{xmrconfirmerror && (
											<SuccessErrorAlert
												detail={
													xmrconfirmerror.response
														.data.detail
												}
												type='error'
											/>
